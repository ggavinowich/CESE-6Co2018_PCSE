...
#define CAN1_RECEIVED_SIGNALS\
   CAN1_SIGNAL(SIG4, 0x304, SAPI_CAN_NO_CALLBACK) \
   CAN1_SIGNAL(SIG5, 0x305, SAPI_CAN_NO_CALLBACK) \
   CAN1_SIGNAL(SIG6, 0x306, SAPI_CAN_NO_CALLBACK) \
   CAN1_SIGNAL(SIG7, 0x307, SAPI_CAN_NO_CALLBACK) \
   CAN1_SIGNAL(SIG8, 0x308, SAPI_CAN_NO_CALLBACK) \
   CAN1_SIGNAL(SIG9, 0x309, SAPI_CAN_NO_CALLBACK)

#define CAN1_TRANSMITTED_SIGNALS \
   CAN1_SIGNAL(SIG1, 0x301) \
   CAN1_SIGNAL(SIG2, 0x302) \
   CAN1_SIGNAL(SIG3, 0x303)
