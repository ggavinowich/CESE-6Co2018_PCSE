...
#define CAN1_RECEIVED_SIGNALS\
   CAN1_SIGNAL(SIG1, 0x301, pFunctionLed) \
   CAN1_SIGNAL(SIG2, 0x302, pFunctionNothing) \
   CAN1_SIGNAL(SIG3, 0x303, pFunctionTick)

#define CAN1_TRANSMITTED_SIGNALS \
   CAN1_SIGNAL(SIG7, 0x307) \
   CAN1_SIGNAL(SIG8, 0x308) \
   CAN1_SIGNAL(SIG9, 0x309)
